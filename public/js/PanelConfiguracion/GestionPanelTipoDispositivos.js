...
function MostrarTiposDispositivos(){
    ...
    $.get('mostrartiposdispositivos',function(data){
        $.each(data, function(i,item){
            ...
            out+="<td><center><a class='fa fa-edit btn btn-info' onclick='ModalPanelConfiguracion(3,"+item.idtipodispositivos+")' title='Modificar datos del registro'></a></center></td>";
            out+="</tr>";
