            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        <div>
                        <center><h3>Ingreso de nuevas especialidades</h3></center>  
                        </div>
                        <br>
                        <input required id="id_descripcion_especialidad" type="text" class="form-control" placeholder="Descripción de la especialidad" autocomplete="off" value="{{ old('dispositivo') }}" />
                        <br>
